...
const Contact = () => {
  ...
  function checkValid() {
    ...
    if (reason === "question/suggestion") {
      ...
      } else if (paymentType === "card" || paymentType === "mobilewallet") {
        if (last4.length !== 4) {
          valid = false;
          setLast4Error(true);
        } else {
      ...
      <div className='contact-parent'>
        ...
        <div>
          ...
          you still see it after a few business days, please let us know. */}
            - If you had an issue at a machine or a transaction issue,{" "}
            <span
              className='contact-qs'
              onClick={() => {
                setReason("Machine/Transaction Issue");

                setTimeout(() => {
                  const ele = $("#form--contact");
                  const n = $(".nav-home").height();

                  window.scrollTo({
                    top: ele[0].getBoundingClientRect().top - n,
                    behavior: "smooth",
                  });
                }, 120);
              }}
          ...
          <div
            className='desc-sectioncontact mbot'
            style={{ marginBottom: "25px" }}
          >
            If it’s an urgent matter, please text Mycha @ (847) 260-8387 or
            email us at{" "}
            <a
                    ...
                    <div style={{ marginTop: "10px" }}>
                      <label className='label-contact'>
                        {paymentType === "card" ? (
                          ...
                          <span>
                            Virtual Account Number / Device Account Number (4
                            digits)
                          </span>
                        )}
                      ...
                      {showTutorial && (
                        <div className='contact-tu'>
                          <div className='contact-tuch'>
                            <div
                              style={{
                                marginBottom: "10px",
                                fontWeight: "500",
                            ...
                            <video controls>
                              <source
                                src='/assets/contact/tutorial-apple.mp4'
                                type='video/mp4'
                              ></source>
                            </video>
                          </div>
                          ...
                          >
                            ...
                            >
                              Tap to pay -> Click on card used -> Details ->
